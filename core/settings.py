...
SECRET_KEY = os.environ.get('SECRET_KEY', default="zm^(s)kna#c^=$zpn*muj7d!(75d_pyqm!0l9#sis2pd5u_^sd")
...
POSTGRES_BD = os.environ.get('POSTGRES_BD', default="Media")
...
CORS_ALLOWED_ORIGINS_REGEXE = [
    ...
    r"^http://\w+\.127.0.0.1:8000$",
    r"^http://\w+\.localhost:3000$",
    r"^http://\w+\.127.0.0.1:3000$",
    r"^http://\w+\.localhost:80$",
    r"^http://\w+\.127.0.0.1:80$",
    r"^https://\w+\.localhost:443$",
    r"^https://\w+\.127.0.0.1:443$"
]
"""
